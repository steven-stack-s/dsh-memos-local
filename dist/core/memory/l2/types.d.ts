 ...
 */
import type { EpisodeId, EpochMs, PolicyId, PolicyRow, SessionId, TraceId, TraceRow } from "../../types.js";
...
export interface InductionResult {
    ...
    traceIds: TraceId[];
    skippedReason: null | "too_few_episodes" | "llm_disabled" | "llm_failed" | "draft_invalid" | "duplicate_of" | "all_below_threshold";
