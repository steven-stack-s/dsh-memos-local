...
import { prioritizeEmbedder, } from "../util/foreground-resources.js";
...
export function buildPipelineSubscribers(deps, buses, algorithm, session, resources) {
...
// ─── Retrieval deps ───────────────────────────────────────────────────────
export function buildRetrievalDeps(deps, algorithm, resources) {
...
function throwLightweight(feature) {
    throw new Error(`pipeline: ${feature} is unavailable while ` +
