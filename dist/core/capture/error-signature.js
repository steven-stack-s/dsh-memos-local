 ...
 */
export function extractErrorSignatures(input) {
    const corpus = [];
...
function normaliseFragment(frag) {
    ...
    if (collapsed.length < MIN_FRAGMENT_LEN)
        return null;
    const truncated = collapsed.length > MAX_FRAGMENT_LEN
