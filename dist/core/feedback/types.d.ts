 ...
 */
export type UserFeedbackShape = "positive" | "negative" | "correction" | "constraint" | "preference" | "confusion" | "instruction" | "unknown";
...
export type RepairTrigger = "failure-burst" | "user.negative" | "user.preference" | "manual";
