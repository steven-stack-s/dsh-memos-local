...
export function createIntentClassifier(opts = {}) {
...
// ─── LLM path ───────────────────────────────────────────────────────────────
const ALLOWED_KINDS = ["task", "memory_probe", "chitchat", "meta", "unknown"];
...
export function listHeuristicRules() {
