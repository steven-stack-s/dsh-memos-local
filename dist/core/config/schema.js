...
const NumberInRange = (def, min, max, description) => Type.Number({
    default: def,
...
const EmbeddingSchema = Type.Object({
     ...
     */
    maxInputTokens: NumberInRange(1_024, 0, 1_000_000, "Maximum estimated tokens per embedding input. Set to 0 to disable client-side chunking."),
...
const AlgorithmSchema = Type.Object({
    ...
    skill: Type.Object({
        ...
        idleArchiveMs: NumberInRange(30 * 24 * 60 * 60 * 1000, 60 * 60 * 1000, 365 * 24 * 60 * 60 * 1000),
    }, { default: {} }),
